...
export function Checkbox({ className, children, ...props }: CheckboxProps) {
  return (
    <CheckboxPrimitive.Root
      data-slot="checkbox"
      className={cn(
        "inline-flex size-5 items-center justify-center rounded-md border border-border bg-surface-1 text-foreground shadow-none transition-[color,background-color,border-color,box-shadow] duration-150 ease-standard motion-reduce:transition-none",
