  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        "data-[checked]:border-emerald-500/25 data-[checked]:bg-emerald-500/10 data-[checked]:text-emerald-800",
        "disabled:cursor-not-allowed disabled:opacity-50 dark:data-[checked]:text-emerald-200",
        className,
      )}
      {...props}
    >
