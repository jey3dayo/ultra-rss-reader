...
export function useSubscriptionsIndexState(rows: SubscriptionListRow[], options?: SubscriptionsIndexStateOptions) {
  ...
  // react-doctor-disable-next-line react-doctor/no-derived-state-effect -- accepted risk (previous-prop tracker), docs/react-doctor-warning-classification-300.md:304
  useEffect(() => {
    ...
    // react-doctor-disable-next-line react-doctor/no-derived-state -- accepted risk (previous-prop tracker), docs/react-doctor-warning-classification-300.md:304
  ...
  useEffect(() => {
    if (visibleRows.length === 0) {
      if (selectedFeedId !== null) {
        // react-doctor-disable-next-line react-doctor/no-adjust-state-on-prop-change -- accepted risk (derived-data selection repair), docs/react-doctor-warning-classification-300.md:317
        setSelectedFeedId(null);
      }
      return;
    }
