  ...
  return (
    ...
    >
      <h1 className="flex max-w-full items-end gap-1.5 text-[1.68rem] leading-[1.03] font-medium tracking-[-0.055em] text-current">
        {accountName}
        {hasMultipleAccounts ? (
          <ChevronDown className="mb-0.5 size-3.5 shrink-0 -translate-y-1 text-sidebar-foreground/56 transition-colors duration-200 group-hover:text-sidebar-foreground/78 motion-reduce:transition-none" />
        ) : null}
      </h1>
