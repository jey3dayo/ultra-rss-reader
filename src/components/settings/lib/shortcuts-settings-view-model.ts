...
export type BuildShortcutsSettingsViewPropsParams = {
...
export function buildShortcutsSettingsViewProps({
  t,
  tReader,
  platformKind,
  recordingId,
  ...
  onStartRecording,
  onBadgeKeyDown,
}: BuildShortcutsSettingsViewPropsParams): ShortcutsSettingsViewProps {
  return {
