...
export function FeedCleanupPageView({
  ...
  return (
    ...
    >
      ...
      <div
        ref={layoutRef}
        className={`min-h-0 flex flex-1 flex-col overflow-hidden pt-1.5 sm:pt-2 ${useDesktopOverlay ? "pl-2 sm:pl-2" : ""}`}
      >
                ...
                {shortcutItems
                  ...
                  .map((item) => (
                    <div
                      ...
                      className="flex items-center gap-3 rounded-md bg-surface-1/72 px-3 py-2"
                    >
                      <kbd className="rounded-md border border-border/80 bg-surface-1/80 px-2 py-1 text-xs font-semibold text-foreground">
                        {item.key}
                      </kbd>
