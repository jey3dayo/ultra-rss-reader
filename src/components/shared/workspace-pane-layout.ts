...
export type WorkspaceDetailPaneWidth = typeof WORKSPACE_DETAIL_PANE_WIDTH;
...
export type WorkspaceDetailPaneGridClassName =
  | typeof WORKSPACE_DETAIL_PANE_GRID_CLASS
  | typeof WORKSPACE_DETAIL_PANE_GRID_CLASS_COMPACT;
...
export type WorkspacePaneLayoutClassName =
  | WorkspaceDetailPaneGridClassName
  | typeof WORKSPACE_CANVAS_CLASS
  | typeof WORKSPACE_CHROME_SPACING_CLASS;
