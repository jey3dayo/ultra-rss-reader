  ...
  return (
    <button
      ...
      className={cn(
        ...
        "motion-interactive-surface motion-contextual-surface rounded-full border border-border/70 bg-surface-2/88 text-foreground-soft select-none shadow-elevation-1 hover:bg-surface-3 hover:text-foreground",
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50",
        "[&_[data-label-chip]]:border-border/45 [&_[data-label-chip]]:bg-background/58 [&_[data-label-chip]]:text-foreground/72",
