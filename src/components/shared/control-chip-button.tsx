  ...
  return (
    <button
      ...
      className={cn(
        ...
        "motion-interactive-surface motion-contextual-surface rounded-md border border-border/70 bg-surface-2/88 text-foreground-soft select-none shadow-elevation-1 hover:bg-surface-3 hover:text-foreground",
