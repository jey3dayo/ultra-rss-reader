...
// react-doctor-disable-next-line react-doctor/no-high-complexity-react-function -- accepted risk (Shared primitive variant matrix), docs/react-doctor-complexity-classification.md:168
