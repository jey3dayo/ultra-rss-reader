...
export const articleFilterInsetSelectionClassName =
  "h-11 rounded-md border-0 bg-transparent px-0 text-[0.82rem] font-medium tracking-[0.01em] shadow-none hover:bg-transparent hover:text-foreground focus-visible:bg-transparent focus-visible:ring-2 focus-visible:ring-ring/45 data-[pressed]:bg-transparent data-[pressed]:text-foreground disabled:cursor-not-allowed disabled:opacity-[0.45] disabled:text-foreground-muted disabled:hover:text-foreground-muted sm:rounded-md sm:bg-transparent sm:px-0 sm:text-[13px] sm:font-medium sm:tracking-normal sm:shadow-none [&_[data-filter-toggle-content]]:rounded-md [&_[data-filter-toggle-content]]:px-3.5 [&_[data-filter-toggle-content]]:py-2 [&_[data-filter-toggle-content]]:transition-colors hover:[&_[data-filter-toggle-content]]:bg-surface-2/36 disabled:hover:[&_[data-filter-toggle-content]]:bg-transparent focus-visible:[&_[data-filter-toggle-content]]:bg-surface-2/56 data-[pressed]:[&_[data-filter-toggle-content]]:bg-surface-2/72 data-[pressed]:[&_[data-filter-toggle-content]]:shadow-active-inset-highlight dark:data-[pressed]:[&_[data-filter-toggle-content]]:bg-surface-3/72 sm:[&_[data-filter-toggle-content]]:px-3";
...
export function articleFilterToggleButtonClassName({
  ...
  return cn(
    ...
    "motion-filter-toggle rounded-md border-0 bg-transparent shadow-none select-none disabled:cursor-not-allowed disabled:opacity-[0.45]",
