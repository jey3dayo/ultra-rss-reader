    ...
    >
      ...
      {onRemove && removeLabel ? (
        <button
          type="button"
          onClick={onRemove}
          className="inline-flex size-4 items-center justify-center rounded-full text-foreground-soft opacity-55 transition-[opacity,color,background-color,box-shadow] duration-150 ease-standard group-hover/tag-chip:opacity-100 group-focus-within/tag-chip:opacity-100 hover:bg-surface-1/72 hover:text-foreground hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/45 focus-visible:opacity-100 motion-reduce:transition-none"
