...
export function DebugHudActionButton({ className, ...props }: DebugHudActionButtonProps) {
  return (
    <Button
      ...
      className={cn(
        "motion-interactive-surface inline-flex h-8 min-w-8 shrink-0 items-center justify-center rounded-md border-0 bg-transparent px-2 text-[11px] font-medium text-white/56 shadow-none outline-none select-none transition-none",
