...
export type AccountSetupTrackedAccountSessionState = "syncing" | "failed" | "succeeded";
export type AccountSetupSessionState = AccountSetupVerificationSessionState | AccountSetupTrackedAccountSessionState;
...
type AccountSetupTrackedAccountSessionBase<State extends AccountSetupTrackedAccountSessionState> = {
  accountId: string;
...
export type AccountSetupSession = AccountSetupAddAccountVerificationSession | AccountSetupTrackedAccountSession;
