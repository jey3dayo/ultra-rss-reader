...
export function getActiveRovingButtonIndex(itemRefs: RovingButtonRefs, activeElement: Element | null): number {
...
export function focusRovingButton(itemRefs: RovingButtonRefs, itemCount: number, index: number) {
