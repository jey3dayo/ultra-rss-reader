...
describe("remote-entry materialization contract", () => {
  ...
  it("does not misclassify known test-fixture `INSERT INTO articles` call sites as production", () => {
    ...
    const knownFixtureFiles = [
      ...
      "commands/sync_commands/tests/mod.rs",
      "commands/sync_commands/tests/progress.rs",
      "commands/sync_commands/tests/startup_repair.rs",
      "commands/sync_commands/tests/local_sync.rs",
      "commands/sync_commands/tests/scheduler_purge.rs",
