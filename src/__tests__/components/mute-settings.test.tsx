...
describe("MuteSettings", () => {
  ...
  it("releases the busy state even when the notification for a failed deletion throws", async () => {
    ...
    // try/finally (rather than a listener registered at the top of the test and torn down at
    // the bottom) so a failing assertion or await partway through this test still removes the
