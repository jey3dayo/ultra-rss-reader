 ...
 * real `ReaderPassiveLayoutProvider`, the seam a direct `registerBody`/`registerCard` call
 * cannot cover: it never renders a context consumer, so it can't see ref-callback identity churn.
 */
function TestPane({
  paneId,
  identityKey,
