...
const REQUIRED_THEME_COLOR_ALIASES = [
  ...
  { aliasName: "--color-state-warning-surface-hover", tokenName: "--state-warning-surface-hover" },
  ...
  { aliasName: "--color-state-success-surface-hover", tokenName: "--state-success-surface-hover" },
  ...
  { aliasName: "--color-state-danger-surface-hover", tokenName: "--state-danger-surface-hover" },
