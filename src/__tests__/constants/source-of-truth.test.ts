...
import { BROWSER_WINDOW_EVENTS, type BrowserWindowEventName } from "@/constants/browser";
...
import { LEGACY_STORAGE_KEYS, STORAGE_KEYS, type StorageKey } from "@/constants/storage";
