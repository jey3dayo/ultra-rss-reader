...
const generatedMockArticles = [
  ...
  createMockArticle({
    id: "art-13",
    feedId: "feed-nhk",
    title: "サッカーW杯 ブラジル戦へ森保監督「勝って歴史変える」",
    summary:
      "サッカーワールドカップ日本代表の森保一監督は決勝トーナメント1回戦のブラジル戦を前に公式会見に臨み、「勝って歴史を変えたい」と意欲を示しました。",
    url: "https://news.web.nhk/newsweb/na/na-k10015163361000",
    author: "NHK",
    date: now,
    hours: 8,
    minutes: 57,
  ...
  createMockArticle({
    ...
    summary: "90日以上未更新カードの見た目を確認するための開発用サンプル記事です。",
