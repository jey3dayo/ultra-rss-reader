    ...
    options: {
      storySort: {
        ...
        order: [
          ...
          "Shared",
          ["Layout", "Inputs", "Rows", "Controls", "Dialogs", "Navigation", "Feedback", "Data Display"],
          "Primitives",
          "Settings",
          ["Shell", "Category", "Account", "Section", "Nav"],
          "Reader",
          ["Article List", "Article", "Sidebar", "Dialog", "Menu", "Browser"],
          "Subscriptions",
          ["Summary", "List", "Detail"],
          "Internal",
          ["Debug", "Review"],
