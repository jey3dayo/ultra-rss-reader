...
// `handle_browser_webview_shortcut_navigation`); the native shortcut handlers intercept those
// keys before the WebView sees them. The one behavior this script owns is Space-key scrolling.
