...
records why family E does not, on the measurement below.
...
rule, path and function name is what found it; that comparison is Issue #324. The two rows below
...
So the table below holds 27 rows, of which the scan reports 25. Its last two are dated later than
the rest.
