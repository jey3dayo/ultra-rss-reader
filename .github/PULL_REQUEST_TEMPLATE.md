...
該当する場合だけ、PR 本文か確認済みに短くメモする。

- release / updater / packaged app / keyring / startup: `mise run ci` だけで足りるか
- SQLite schema bump: 旧バージョンで起動できなくなる影響があるか
- startup bundle: app shell / design-system barrel / command palette 変更で初期 chunk が増えていないか
