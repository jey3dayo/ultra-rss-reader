...
- Definition of Done quality checks follow the PR template quality gate checklist: run `mise run check`; for jsdom, DOM, React rendering, PR handoff, release, native, or Storybook impact, record `mise run test:unit:dom`, `mise run ci`, or a focused test in the PR verification notes.
